...
//     try {
//       final data = await ApiService.fetchData('getUsers');
//       return data;
//     } catch (e) {
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text('Полученные данные')),
//       body: FutureBuilder<dynamic>(
//         future: getData(), // Вызов функции для получения данных
...
//             return Center(
//               child: Text('Полученные данные: ${snapshot.data}'),
//             );
//           } else {
